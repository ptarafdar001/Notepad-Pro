...
def change_bold():
    ...
    # actual() method return dictionary
...
def changed(event=None):
    ...
    if text_editor.edit_modified():
        ...
        status_bar.config(text=f"Char:{characters} Words:{words}")
...
def find_func(event=None):
    ...
    # frame
    find_frame = ttk.LabelFrame(find_dialogue, text='Find/Replase')
...
# edit commands and functionality
...
# view command and functionality
...
view.add_checkbutton(label='Status Bar', onvalue=True, offvalue=0, variable=show_statusbar,
                     image=statusbar_icon, compound=tk.LEFT, command=hide_statusbar)

# color Theme and functionality
